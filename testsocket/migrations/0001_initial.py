    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None), size=None)),
                ('gold', models.IntegerField(default=0)),
                ('maxInventorySpace', models.IntegerField(default=64)),
                ('weaponSlot', models.IntegerField(default=0)),
                ('armorSlot', models.IntegerField(default=0)),
                ('pickSlot', models.IntegerField(default=0)),
                ('shovelSlot', models.IntegerField(default=0)),
                ('hoeSlot', models.IntegerField(default=0)),
                ...
                ('posMap', models.CharField(default='map', max_length=10)),
                ('posDirection', models.IntegerField(default=1)),
